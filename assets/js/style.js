/*
TO ADD
1) mobile: done except height issue: some kind of margin on my panels?
2) add admin interface- allow user to create new post, link to show previous?
3) images not working with overflow hidden
*/
const init = function() {
  const colors = [
